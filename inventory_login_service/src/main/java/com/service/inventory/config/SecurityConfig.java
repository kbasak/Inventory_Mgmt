...
import com.service.inventory.filters.JwtRequestFilter;
...
class SecurityConfigurer extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		.antMatchers(HttpMethod.GET, "/health-check","/checkUser/**","/getAllUsers").hasRole("ADMIN")
		.antMatchers(HttpMethod.PUT,"/upgradeUser/**").hasRole("ADMIN")
		.antMatchers(HttpMethod.GET, "/validate").hasAnyRole("USER","ADMIN")
		.antMatchers(HttpMethod.GET,"/getUsers").hasAnyRole("USER","ADMIN")
